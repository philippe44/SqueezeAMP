...
A small display like [this](https://www.aliexpress.com/item/1005001680040131.html) one with low profile connector like [that](https://www.aliexpress.com/item/4000147221999.html) can be directly connected to the 6 pins 2.54 mm connector and nicely fits inside the case.
![alt text](https://github.com/philippe44/SqueezeAMP/blob/master/Boost with OLED - angled.png?raw=true)
